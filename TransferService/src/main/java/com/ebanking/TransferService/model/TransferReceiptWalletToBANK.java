...
@Builder
@Service
public class TransferReceiptWalletToBANK {
        ...
        public TransferReceiptWalletToBANK(String orderingFullName, String beneficiariesFullName, double amount,
                                          String orderingRib, String initiatedAt, String transferType, String reference  , String cin, Boolean isInitiatedFromMobile) {
