...
@Builder
@Service
public class TransferReceiptWalletToGAB {
    ...
    public TransferReceiptWalletToGAB(String orderingFullName, String beneficiariesFullName, double amount,
                           String orderingRib, String initiatedAt, String transferType, String reference  , Boolean isInitiatedFromMobile) {
